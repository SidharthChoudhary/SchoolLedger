...
from .views import (
    ...
    monthly_ledger_report,
    monthly_ledger_report_csv,
    monthly_ledger_report_pdf,
    export_expenses_csv,
    delete_all_expenses,
    export_income_csv,
    delete_all_income,
...
urlpatterns = [
    ...
    path("monthly-ledger-report/", monthly_ledger_report, name="monthly_ledger_report"),
    path("monthly-ledger-report/export-csv/", monthly_ledger_report_csv, name="monthly_ledger_report_csv"),
    path("monthly-ledger-report/export-pdf/", monthly_ledger_report_pdf, name="monthly_ledger_report_pdf"),
